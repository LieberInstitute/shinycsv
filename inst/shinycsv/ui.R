            ...
            mainPanel(
                tabsetPanel(
                    ...
                    tabPanel('Documentation',
                        ...
                        hr(),
                        HTML('View this app in the default <a href ="https://libd.shinyapps.io/shinycsv/">mode</a> or the <a href="https://libd.shinyapps.io/shinycsv-showcase/">showcase mode</a> (it is useful for learning shiny).')
                    ),
                    hr(),
                    p('This shiny application was developed by the data science team at the Lieber Institute for Brain Development.'),
                    hr(),
                    p(HTML('<a href="http://www.libd.org/"><img src="http://lcolladotor.github.io/img/LIBD_logo.jpg" align="left" width="250px"/></a>')),
                    tags$br(),
                    tags$br(),
                    tags$br(),
                    tags$br(),
